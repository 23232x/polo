<?php
// Template Name: Formacao-de-Professores-para-a-Educacao-Profissional-UFSM
?>
    ...
    while (have_posts()) {
        ...
        <div class="section container">
            ...
            <div class="title-section courses">
                ...
                <h4 class="small-title">Formação de Professores para a Educação Profissional - UFSM</h4>
                <ul>
                    <li>
                        <span>
                            Curso de Graduação em Formação de Professores para a Educação Profissional - UFSM
