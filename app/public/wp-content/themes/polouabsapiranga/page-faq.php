...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <section class="main-page bg">
            <div class="contend-section">
                ...
                <div class="faq-item">
                    <!-- add class 'on' with js - must be like this <div class="faq-title on"> -->
                    <button class="faq-title" id="faq02">
                        <h4 id="faq02">O que é um Polo UAB?</h4>
                        <img class="cross" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/faq/plus.svg" alt="">
                    </button>
                    <p class="faq-answer" id="faqanswer2" style="display: none;">
                ...
                <div class="faq-item">
                    <!-- add class 'on' with js - must be like this <div class="faq-title on"> -->
                    <button class="faq-title" id="faq03">
                        <h4 id="faq03">Quem é o mantenedor do Polo UAB?</h4>
                        <img class="cross" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/faq/plus.svg" alt="">
                    </button>
                    <p class="faq-answer" id="faqanswer3" style="display:none;">
...
<script>
    //####### Show and hide faq item 1 ##########
    var btn1 = document.getElementById("faq01");

    btn1.addEventListener("click", function() {

        var exibe1 = document.getElementById("resposta1");

        if (showResposta.classList.contains("swanw") && btnfaq01.classList.contains("on")) {
            showResposta.classList.remove("swanw");
            getid.classList.remove("on");
        } else {
            showResposta.classList.add("swanw");
            getid.classList.add("on");
        }
    });

    //####### Show and hide faq item 2 ##########
</script>