<?php
// Template Name: Informatica-Instrumental-Professores-Educação-Basica-UFRGS
?>
    ...
    while (have_posts()) {
        ...
        <div class="section container">
            ...
            <div class="title-section courses">
                <h4>Informática Instrumental para Professores da Educação Básica - UFRGS</h4>
                <ul>
                    <li>
                        <span>
                            Curso de Pós Graduação Plea UFRGS.
                        </span>
                    </li>
                </ul>
            </div>
