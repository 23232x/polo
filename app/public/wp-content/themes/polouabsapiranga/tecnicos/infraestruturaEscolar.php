<?php
// Template Name: infraestruturaEscolar
?>
<?php get_header(); ?>
    ...
    while (have_posts()) {
        ...
        <div class="section container">
            ...
            <div class="title-section courses">
                <h4>Infraestrutura Escolar</h4>
                <ul>
                    <li>
                        <span>
                            Curso técnico em Infraestrutura Escolar - IFSUL
                        </span>
                    </li>
                </ul>
            </div>
            ...
            <section class="main-page">
                <div class="container contend-section-course">
                    ...
                    <p class="text mininal-detail">
                        ...
                        Perfil
                        O profissional concluinte do Curso Técnico em Infraestrutura Escolar, na modalidade a distância, integrante do PROFUNCIONÁRIO, oferecido pelo IFSul, deve apresentar um perfil de egresso que o habilite a desempenhar atividades voltadas para a atuação em Infraestrutura Escolar, na área de Desenvolvimento Educacional e Social.
                    ...
                    <p class="text" style="padding-left: 6rem;">Acesse o <a href="http://ead.ifsul.edu.br/index.php/cursos?id=189" target="_blank">Site </a> Oficial do curso e veja a grade curricular completa.</p>
            </section>
        </div>
