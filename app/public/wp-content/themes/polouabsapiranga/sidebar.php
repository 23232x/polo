...
<div id="sidebar" role="complementary">
    <ul class="ul-teste">
        ...
        ?>
            <!-- <li>
                the function get_search_form(); goes here 
            </li>
            -->
                    ...
                    <?php elseif (is_search()) : /* If this is a search result */ ?>
                        <p>
                            ...
                            printf(
                                ...
                                __('<p class="olas container">você pesquisou nos arquivos do site %1$s por <strong>&#8216;%2$s&#8217;</strong>. Caso você não tenha econtrando o que procura, tente em alguma das páginas abaixo relacionadas, 
                                ou utilize nova palavra chave no campo de pesquisa.'),
                                sprintf('<a href="%1$s/">%2$s</a>', get_bloginfo('url'), get_bloginfo('name')),
    ...
    <ul role="navigation" class="ul-teste2">
