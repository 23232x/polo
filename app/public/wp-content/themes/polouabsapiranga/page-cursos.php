                            ...
                            <button class="accordion">
                                ...
                                <?php $cursos_gradu = get_cmb2field('cursos_gradu');
                                   ...
                                   foreach ($cursos_gradu as $gradu) { ?>
                                        <a href="<?php echo $gradu['course_tec_link']?>"target="_blank" >
                            ...
                            <button class="accordion">
                                ...
                                <?php $cursos_pos = get_cmb2field('cursos_pos');
                                   ...
                                   foreach ($cursos_pos as $pos) { ?>
                                        <a href="<?php echo $pos['course_tec_link']?>" target="_blank">
                                            <p title="<?php echo $pos['course_pos_name'] ?>"><?php echo $pos['course_pos_name']?></p>
                                        </a>
                                     <?php
                                     }
                                    }
